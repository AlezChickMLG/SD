package beerApp.persistence.repositories

import beerApp.models.Beer
import beerApp.persistence.interfaces.IBeerRepository
import beerApp.persistence.mappers.BeerRowMapper
...
class BeerRepository: IBeerRepository {
    ...
    override fun add(beer: Beer) {
        try {
            ...
            println("An error has occurred in ${this.javaClass.name}.add: ${e.message}")
        }
    }
    ...
    override fun update(beer: Beer) {
        try {
            ...
            println("An error has occurred is ${this.javaClass.name}.update")
        }
    }
